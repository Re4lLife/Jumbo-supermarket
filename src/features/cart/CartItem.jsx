    ...
    return (
        <div className="flex flex-col md:flex-row items-center border-b border-gray-200 py-6 hover:bg-gray-50 transition duration-150">
            ...
            <div className="flex justify-between items-center w-full md:w-3/5 lg:w-2/3 space-x-6">
                ...
                <Modal>
                    <Modal.Open name='delete-cart-item'>
                        <MdDelete
                            className="text-5xl text-red-500 hover:text-red-700 transition duration-150 p-2 rounded-full hover:bg-red-50 flex-shrink-0"
                        />
                    </Modal.Open>

                    <Modal.Window name='delete-cart-item'>
                        <ConfirmDelete
                            thumbnail={thumbnail}
                            disabled={isDeleting}
